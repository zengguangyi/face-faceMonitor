...
<body>
	<div class="page">
		...
		<div class="content">
			<form action="<?php echo U('Addperson/addper');?>" method="post" id="addperson">
				<div class="list-block">
					...
					<input type="submit" value="提交" class="button button-big button-fill button-success" id="submit_btn" />
				</div>
			</form>
	...
	<div class="panel panel-right panel-reveal theme-dark" id='panel-left-demo'>
		<div class="content-block">
			...
			<p class="mySidebarTitle"><a href="#" class="button button-fill"><span class="icon icon-down" id="mySidebarIcon1"></span>添加训练素材</a></p>
			<div id="mySidebarHid">
